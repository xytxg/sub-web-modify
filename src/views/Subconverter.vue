  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [ { value: "https://subapi.xytx.org" } ],
        remoteConfig: [
          {
            label: "CM规则",
            options: [
